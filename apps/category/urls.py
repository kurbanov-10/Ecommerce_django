...
urlpatterns = [
    ...
    path("api/list/", category_list, name="category_list"),
    path("api/create/", category_create_view, name="category_create"),
    path("api/update/<int:pk>/", category_update_view, name="category_update"),
    path("api/delete/<int:pk>/", category_update_view, name="category_delete"),
    path("api/<int:pk>/", category_detail_view, name="category_detail"),
]
